...
[![Codecov test coverage](https://codecov.io/gh/leonawicz/imgpalr/graph/badge.svg)](https://app.codecov.io/gh/leonawicz/imgpalr)
[![CRAN status](https://www.r-pkg.org/badges/version/imgpalr)](https://CRAN.R-project.org/package=imgpalr)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/imgpalr)](https://cran.r-project.org/package=imgpalr) 
[![Github Stars](https://img.shields.io/github/stars/leonawicz/imgpalr.svg?style=social&label=Github)](https://github.com/leonawicz/imgpalr)
<!-- badges: end -->
